...
export const VERIFICATION_URL = `${BASE_URL}/merchant/app/verification-nik`;
...
export const VERIFICATION_ENDPOINT = `${BASE_ENDPOINT}/customers/v2/verify-nik`;
...
export const VERIFICATION_DELAY = 6 * 1000;
